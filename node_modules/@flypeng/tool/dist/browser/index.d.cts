 ...
 * @returns
 */
declare function useDeepClone(targetObj: any, hashMap?: WeakMap<WeakKey, any>): any;
 ...
 * @param isExecute
 */
declare function useThrottle(callback: Function, delay: number, isExecute?: boolean): (this: unknown, ...rest: unknown[]) => any;
...
declare const _default: {
    ...
    useIsSameMonth: typeof useIsSameMonth;
};
...
interface UseHtmlToImageOptions {
    target?: HTMLElement;
    filename?: string;
 ...
 */
declare function useHtmlToImage(htmlToImageOptions: UseHtmlToImageOptions): Promise<void>;
 ...
 * @returns
 */
declare function useDataSensitive(options: DataSensitiveOptions): string;
...
export { TouchBottomClass, useCalendarSwitch, useCheckEmailUrl, useCheckIdCard, useCheckIncludeChinese, useCheckIncludeEmoji, useCheckIncludeNumber, useCheckPasswordStrength, useCheckPhoneNumber, useCheckQQNumber, useCheckUrl, useClearLocal, _default as useCommonDate, _default$1 as useCommonType, useCopyContent, useCopySelector, useCustomContextMenu, useDataSensitive, useDayjs, useDebounce, useDeepClone, useDelEmptyValue, useDownloadFile, useDynamicLoadScript, useFormatDate, useGetBrowserInfo, useGetLocalKey, useGetUrlParam, useGoToTop, useHtmlToImage, useListenNetwork, useLocalStorage, useLocationInfo, useLodash, useMobileDevice, useNumberSeparate, useObjectIsEmpty, useOnce, usePageTabSwitch, usePreventSeeSourceCode, useRandomHexColor, useRandomInteger, useRandomString, useRemoveLocalKey, useScrollToBottom, useScrollToElement, useSetLocalKey, useThrottle, useToggleFullScreen, useTransformCase };
