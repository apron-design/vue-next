...
<script setup lang="ts">
import { SkeletonTitle, SkeletonParagraph } from '@apron-design/vue-next'
</script>
```
:::
...
<script setup lang="ts">
import { SkeletonParagraph } from '@apron-design/vue-next'
</script>
```
:::
...
<script setup lang="ts">
import { SkeletonImage, SkeletonTitle, SkeletonParagraph, SkeletonButton } from '@apron-design/vue-next'
</script>
```
:::
...
<template>
  <div style="width: 400px; display: flex; flex-direction: column; gap: 16px;">
    <div v-for="i in 3" :key="i" style="display: flex; gap: 12px;">
      <ad-skeleton-avatar />
      <div style="flex: 1;">
...
<script setup lang="ts">
import { SkeletonAvatar, SkeletonTitle, SkeletonParagraph } from '@apron-design/vue-next'
</script>
```
:::
...
<script setup lang="ts">
import { SkeletonElement, SkeletonButton } from '@apron-design/vue-next'
</script>
```
:::
...
<script setup lang="ts">
import { SkeletonAvatar, SkeletonTitle, SkeletonElement, SkeletonParagraph, SkeletonButton } from '@apron-design/vue-next'
</script>
```
:::
...
| 名称 | 说明 |
| --- | --- |
| default | 子元素（loading 为 false 时显示） |
